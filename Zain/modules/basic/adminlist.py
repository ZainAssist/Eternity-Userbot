...
from Zain.helper.basic import edit_or_reply
from Zain.helper.parser import mention_html, mention_markdown
...
add_command_help(
    "tag",
    [
        [f".admins", "⚜️Get chats Admins list.⚜️"],
        [f".kickdel or .zombies", "⚜️To Kick deleted Accounts.⚜️"],
        [
            f".everyone `or` .mentionall",
            "⚜️to mention Everyone⚜️ ",
        ],
        [
            f".botlist",
            "⚜️To get Chats Bots list⚜️",
        ],
    ],
)
