...
add_command_help(
    ...
    [
        [
            ".autoscroll",
            "Send .autoscroll in any chat to automatically read all sent messages until you call⚜️ "
            "autoscroll again. This is useful if you have Telegram open on another screen.⚜️",
        ],
    ],
)
